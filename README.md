...
Unity로 3D 기반 콘텐츠를 개발하고 Maya로 미륵사지 석탑을 모델링하여 제작된 문화재 관람 목적의 메타버스 플랫폼입니다.

개발 기간 : 2021.09.24 ~ 21.12.10

개발 환경 : Unity 2020.3.20f, Maya

빌드 플랫폼 : PC (Windows)

개발 인원 : 5명(기획 1, 개발 2, 모델링 2)
...
- 미륵사지 설화 스토리 시나리오 작성 및 스토리 연출 구현
...
![창의대첩 대상](https://github.com/user-attachments/assets/3595f792-a635-47f3-a263-364d3fe1c63b)

- 2021 언택트 캡스톤디자인 경진대회 & 공학과 창작의 만남 : 장려상
[공학과 창작의 만남 장려상.pdf](https://github.com/user-attachments/files/16758186/default.pdf)
